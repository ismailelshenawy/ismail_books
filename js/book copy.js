...
var drowpDownApi1 = document.getElementById("drowpDownApi");
...
// ========================= start fuction drowpDown =============
// function drowpDownApi() {
//   var search3 = drowpDownApi1.value;
//   console.log(search3);

// async function gitApiBook() {
//   readBook1 = await fetch(
//     `https://api.nytimes.com/svc/books/v3/lists/current/${search3}.json?api-key=dUI0I7UN98DTkJjq2AianRrGrqCdxqKS`
//   );
